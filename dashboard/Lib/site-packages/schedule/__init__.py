...
An in-process scheduled_crawler for periodic jobs that uses the builder pattern
...
class Job(object):
    ...
    * a quantity of `time units` defined by `interval`
    ...
    def __init__(self, interval, scheduler=None):
        ...
        self.scheduler = scheduler  # scheduled_crawler to register with
...
def every(interval=1):
    ...
    :data:`default scheduled_crawler instance <default_scheduler>`.
    """
