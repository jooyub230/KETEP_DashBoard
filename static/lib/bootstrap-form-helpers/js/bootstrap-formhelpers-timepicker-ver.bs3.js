...
//          iconRight = '<div class="input-group-append"><button style="min-width: 2.5rem" class="btn btn-outline-secondary" type="button"><i class="' + this.options.icon + '"></i></button></div>';
        } else {
            iconLeft = '<span class="input-group-addon"><i class="' + this.options.icon + '"></i></span>';
//            iconLeft = '<div class="input-group-prepend"><button style="min-width: 2.5rem" class="btn btn-outline-secondary" type="button"><i class="far fa-clock"></i></button></div>';
        }
      ...
      this.$element.html(
        '<div class="' + iconAddon + ' input-group-sm bfh-timepicker-toggle" data-toggle="bfh-timepicker">' +
        iconLeft +
