...
//        this.$element.parent().append('<div class="input-group-append"><button style="min-width: 2.5rem" class="btn btn-outline-secondary bfh-number-btn inc" type="button"><i class="fas fa-chevron-up"></i></button><button style="min-width: 2.5rem" class="btn btn-outline-secondary bfh-number-btn dec"><i class="fas fa-chevron-down"></i></button></div>');
      }
...
//      $this = $(this).parent().parent().find('.bfh-number').data('bfhnumber');
